function [x, fval, f_iter, x_iter] =  nelder_mead(x0, funtol, xtol, iterlim, outp)
...
%   X_ITER contains the best point x at every iteration. F_ITER contains 
%   the objective function value f(x) at every iteration. If outp is passed
...
while k < iterlim
    ...
    if (flatness <= funtol) && (simplex_size <= xtol)
